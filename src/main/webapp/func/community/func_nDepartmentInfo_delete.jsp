    ...
    <div class="row">
            ...
            <div class="list-group">
                ...
                <div class="sidebar-menu list-group-item list-group-item-info">
                    ...
                    <ul id="d_menu" class="nav nav-list collapse menu-second">
                        ...
                        <li><a href="#" class="list-group-item list-group-item-info" style="font-size: 0.8em">机构信息删除</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-sm-10">
            ...
            <div class="col-sm-10">
                <div class="jumbotron">
                    <h2>社区机构信息管理</h2>
                    <p>您可以输入将要删除的机构的名称、以及所在小区的名称，即可将该机构从系统中删除。</p>
                    <p id=""></p>
                </div>
            </div>
            ...
            <div class="col-sm-10" style="margin-bottom: 12px">
                <form class="form-horizontal" id="departmentInfo">
                    <div class="form-group">
                        <label for="Nname" class="col-sm-2 control-label">小区名称</label>
                        <div class="col-sm-4">
                            <input type="text" name="nname" class="form-control" id="Nname"
                                   placeholder="请输入将删除的机构所在小区名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="Dname" class="col-sm-2 control-label">机构名称</label>
                        <div class="col-sm-4">
                            <input type="text" name="dname" class="form-control" id="Dname" placeholder="请输入将删除的机构名称">
                        </div>

                        <button type="button" class="btn btn-default" tabindex="-1" onclick="findThis()">机构信息</button>
...
<script type="text/javascript">
    function findThis() {
        ...
        var nname=$("#Nname").val();
        var dname=$("#Dname").val();
        var jsonstr = '{"nname":"'+ nname +'","dname":"' + dname +'"}';
...
<script type="text/javascript">
    function deleteThis() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/nDepartment/deleteNDepartmentByNameAndDname",
            data: jsonstr,
            dataType: "json",
            contentType: "application/json;charset=utf-8",
            success: function (data) {
                if (data.msg=="success"){
                    $("#result_table").attr("hidden", "hidden");
                    $("#msg").html("<h3 style=\"color:lightgreen\">提示: 该机构的信息已成功删除!</h3>");

                }else{
                    $("#result_table").attr("hidden", "hidden");
                    $("#msg").html("<h3 style=\"color:orangered\">提示: 未找到该机构，请检查机构名称或小区名称</h3>");
                }
            },
            error: function (xhr) {
                alert("出错了!succes未执行");
