            ...
            <div class="list-group">
                ...
                <div class="sidebar-menu list-group-item list-group-item-info">
                    ...
                    <ul id="d_menu" class="nav nav-list collapse menu-second">
                        ...
                        <li><a href="#" class="list-group-item list-group-item-info" style="font-size: 0.8em">机构信息修改</a>
                        </li>
            ...
            <div class="col-sm-10" style="margin-bottom: 12px">
                <div class="col-lg-10">
                    <form role="form" id="nDpartmentInfo">
                        ...
                        <button type="button" class="btn btn-default" onclick="updateND()">提交</button>
...
<script type="text/javascript">
    function updateND() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/nDepartment/updateNDepartment",
            data: jsonstr,
            dataType: "json",
            ...
            success: function (data) {
                ...
                if (data.msg == "success") {
                    alert("chenggong xiu gai ");
                    $("#msg").html("<h3 style=\"color:lightgreen\">提示:该机构的信息已成功修改!</h3>");
                    $("#nDpartmentInfo").attr("hidden", "hidden");
                } else {
                    $("#msg").html("<h3 style=\"color:orangered\">提示:没找到该机构!请检查要修改的机构信息</h3>");
                }
            },
            error: function (xhr) {
                alert("出错了!succes未执行");
