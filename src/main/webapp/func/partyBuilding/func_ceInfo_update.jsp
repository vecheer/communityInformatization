                ...
                <div class="col-lg-10">
                    ...
                    <form role="form" id="activeMemberInfo">
                        <div class="form-group">
                            ...
                            <input name="ceid" type="text" class="form-control"
                                   value="${param.ceid==null?"":param.ceid}" placeholder="请输入编号 ">
                        </div>
                        <div class="form-group">
                            <label>活动名称</label>
                            <input name="cename" type="text" class="form-control"
                                   value="${param.cename==null?"":param.cename}" placeholder="请输入活动名称 ">
                        </div>
                        <div class="form-group">
                            <label>举行时间</label>
                            <input name="cedate" type="text" class="form-control"
                                   value="${param.cedate==null?"":param.cedate}" placeholder="请输入活动举行时间 ">
                        </div>
                        <div class="form-group">
                            <label>举办地点</label>
                            <input name="ceplace" type="text" class="form-control"
                                   value="${param.ceplace==null?"":param.ceplace}" placeholder="请输入活动举办地点 ">
                        </div>
                        <div class="form-group">
                            <label>活动主题</label>
                            <input name="cetheme" type="text" class="form-control"
                                   value="${param.cetheme==null?"":param.cetheme}" placeholder="请输入活动主题 ">
                        </div>
                        <div class="form-group">
                            <label>主办方</label>
                            <input name="cesponsor" type="text" class="form-control"
                                   value="${param.cesponsor==null?"":param.cesponsor}" placeholder="请输入活动主办方 ">
                        </div>
                        <div class="form-group">
                            <label>参与人数</label>
                            <input name="ceparticipantnum" type="text" class="form-control"
                                   value="${param.ceparticipantnum==null?"":param.ceparticipantnum}" placeholder="请输入活动参与人数 ">
                        </div>
                        <div class="form-group">
                            <label>活动介绍</label>
                            <input name="ceinfo" type="text" class="form-control"
                                   value="${param.ceinfo==null?"":param.ceinfo}" placeholder="请输入活动的大致介绍 ">
                        </div>
...
<script type="text/javascript">
    function update() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/communistEvent/updateCommunistEvent",
            data: jsonstr,
            dataType: "json",
            ...
            success: function (data) {
                ...
                if (data.msg == "success") {
                    $("#msg").html("<h3 style=\"color:lightgreen\">提示:该党建活动的信息已成功修改!</h3>");
                } else {
                    $("#msg").html("<h3 style=\"color:orangered\">提示:没找到该活动相关的信息!请检查活动名称和举办部门</h3>");
                }
            },
            error: function (xhr) {
                alert("出错了!succes未执行");
