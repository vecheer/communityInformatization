                ...
                <div class="col-lg-10">
                    ...
                    <form role="form" id="activeMemberInfo">
                        <div class="form-group">
                            <label>姓名</label>
                            <input name="aname" type="text" class="form-control" placeholder="请输入姓名 "/>
                        </div>
                        <div class="form-group">
                            <label>性别</label>
                            <input name="asex" type="text" class="form-control" placeholder="请输入性别 "/>
                        </div>
                        <div class="form-group">
                            <label>民族</label>
                            <input name="anationality" type="text" class="form-control" placeholder="请输入民族 "/>
                        </div>
                        <div class="form-group">
                            <label>身份证号码</label>
                            <input name="aidnum" type="text" class="form-control"placeholder="请输入身份证号码 "/>
                        </div>
                        <div class="form-group">
                            <label>受教育程度</label>
                            <input name="aedulevel" type="text" class="form-control" placeholder="请输入受教育程度 "/>
                        </div>
                        <div class="form-group">
                            <label>任职时间</label>
                            <input name="aworkentrytime" type="text" class="form-control" placeholder="请输入任职时间 "/>
                        </div>
                        <div class="form-group">
                            <label>任职单位</label>
                            <input name="aworkat" type="text" class="form-control" placeholder="请输入任职单位 "/>
                        </div>
                        <div class="form-group">
                            <label>担任职务</label>
                            <input name="aduty" type="text" class="form-control" placeholder="请输入担任职务 "/>
                        </div>
                        <div class="form-group">
                            <label>家庭住址</label>
                            <input name="aaddress" type="text" class="form-control" placeholder="请输入家庭住址 "/>
                        </div>
                        <div class="form-group">
                            <label>入团时间</label>
                            <input name="aleagueentrydate" type="text" class="form-control" placeholder="请输入xx年xx月xx日 "/>
                        </div>
                        <div class="form-group">
                            <label>成为积极分子日期</label>
                            <input name="abeamdate" type="text" class="form-control" placeholder="请输入xx年xx月xx日">
                        </div>
                        <div class="form-group">
                            <label>入党推荐人</label>
                            <input name="areferrer" type="text" class="form-control" placeholder="请输入推荐人姓名"/>
                        </div>
                        <div class="form-group">
                            <label>培养支部</label>
                            <input name="ajoinbranch" type="text" class="form-control" placeholder="请输入支部名称 "/>
                        </div>
...
<script type="text/javascript">
    function save() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/activeMember/saveActiveMember",
            data: jsonstr,
            dataType: "json",
