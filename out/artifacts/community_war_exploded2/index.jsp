            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">信息<span class="caret"></span></a>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                    <h2>党建查看</h2>
                    <p><a href="n_info.jsp" style="text-decoration: none;font-size: 2em">小区信息</a></p>
                </div>
                <div class="col-lg-4 col-xs-6">
                    <h2>文件管理</h2>
        ...
        <div class="col-sm-3" id="log_not">
            ...
            <div class="panel-body" >
                <form role="form" id="userInfo">
                    ...
                    <button id="btn" type="button" class="btn btn-block btn-primary">
                        登录
                    </button>
                    <div class="form-group" id="log_tip" style="color: orangered" ></div>
                    <div class="form-group" >
                        <a href="n_info.jsp" id="toRegisterAccount">没有账号?</a>
                    </div>
