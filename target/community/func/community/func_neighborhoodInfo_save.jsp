    ...
    <div class="row">
            ...
            <div class="list-group">
                ...
                <div class="sidebar-menu list-group-item list-group-item-info">
                    ...
                    <ul id="n_menu" class="nav nav-list collapse menu-second">
                        ...
                        <li><a href="#" class="list-group-item list-group-item-info" style="font-size: 0.8em">小区信息添加</a>
                        </li>
        ...
        <div class="col-sm-10">
            ...
            <div class="col-sm-10">
                <div class="jumbotron">
                    <h2>社区信息管理</h2>
                    <p>亲爱的人民公仆，您好。请您在下方表单中，填入需要增加的小区信息，然后点击提交按钮，即可保存到数据库中。</p>
                    <p id=""></p>
                </div>
            </div>
            ...
            <div class="col-sm-10" style="margin-bottom: 12px">
                <div class="col-lg-10">
                    ...
                    <%--修改提示--%>
                    <div id="save_msg" style="text-align: center"></div>
                </div>
            </div>
...
<script type="text/javascript">
    function updateNeighborhood() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/neighborhood/saveNeighborhood",
            data: jsonstr,
            dataType: "json",
            ...
            success: function (data) {
                ...
                if (data.msg=="success"){
                    $("#save_msg").html("<h3 style=\"color:lightgreen\">[提示]新小区的信息已经成功添加!</h3>");
                    $("#neighborhoodInfo").attr("hidden", "hidden");
                }else{
                    $("#save_msg").html("<h3 style=\"color:orangered\">[提示]该小区已经存在，请添加新的小区</h3>");
                }
            },
            error: function (xhr) {
                alert("出错了!succes未执行");
