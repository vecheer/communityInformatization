            ...
            <div class="list-group">
                ...
                <div class="sidebar-menu list-group-item list-group-item-info">
                    ...
                    <ul id="nR_menu" class="nav nav-list collapse menu-second">
                        ...
                        <li><a href="func_nResidentInfo_update.jsp" class="list-group-item list-group-item-info" style="font-size: 0.8em">居民信息修改</a>
                        </li>
                        <li><a href="#" class="list-group-item list-group-item-info" style="font-size: 0.8em">居民信息添加</a>
                        </li>
                ...
                <div class="col-lg-10">
                    <form role="form" id="nResidentInfo">
                        <div class="form-group">
                            ...
                            <input id="Rname" name="rname" type="text" class="form-control" placeholder="请输入新增居民的姓名">
                        </div>
                        <div class="form-group">
                            <label for="Ridnum">身份证</label>
                            <input id="Ridnum" name="ridnum" type="text" class="form-control" placeholder="请输入新增居民身份证号">
                        </div>
                        <div class="form-group">
                            <label for="Nid">所在小区编号</label>
                            <input id="Nid" name="nid" type="text" class="form-control" placeholder="请输入新增居民所在小区编号">
                        </div>
                        <div class="form-group">
                            <label for="Nname">所在小区名称</label>
                            <input id="Nname" name="nname" type="text" class="form-control" placeholder="请输入新增居民所在小区名称">
                        </div>
                        <div class="form-group">
                            <label for="Bid">楼栋号</label>
                            <input id="Bid" name="bid" type="text" class="form-control" placeholder="请输入新增居民所在楼栋">
                        </div>
                        <div class="form-group">
                            <label for="Hidnum">房号</label>
                            <input id="Hidnum" name="hidnum" type="text" class="form-control" placeholder="请输入新增居民所在房号">
                        </div>
...
<script type="text/javascript">
    function save(){
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/nResident/saveNResident",
            data: jsonstr,
            dataType: "json",
            ...
            success: function (data) {
                ...
                if (data.msg=="success"){
                    $("#msg").html("<h3 style=\"color:lightgreen\">[提示]新居民的信息已经成功添加!</h3>");
                    $("#nResidentInfo").attr("hidden", "hidden");
                }else{
                    $("#msg").html("<h3 style=\"color:orangered\">[提示]系统中已存在该居民的信息，请勿重复添加</h3>");
                }
            },
            error: function (xhr) {
                alert("出错了!succes未执行");
